...
parser.add_argument('--config', type=str, help='training configuration name in options.json', default='charging01')
parser.add_argument('--save', type=int, help='whether to save data', default=1)

args = parser.parse_args()

# example: python charging_task.py --T 10 --tau 5 --delta 2 --gridsize 5 --alg naive --suffix 0420 --config charging01 --save 1
...
task = Formula_task_FG(op_out='F', 
                     op_in=['G'], 
                     T=T, tau=[tau], delta=delta, target=region[2,:])
